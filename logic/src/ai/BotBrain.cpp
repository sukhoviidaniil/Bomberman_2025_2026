...
BotPersonality personality_from_string(const std::string& value) {
    ...
    throw std::runtime_error("unknown bot personality '" + value + "' (expected balanced, aggressive or collector)");
}
...
BotPersonality BotBrain::personality() const { return personality_; }
