...
std::unordered_map<TilePos, TilePos, TilePosHash> sweep(const TileGrid& grid, const TilePos& from,
                                                        const CellPredicate& passable, const CellPredicate& stop,
                                                        int max_depth, std::optional<TilePos>& reached) {
...
std::vector<TilePos> rebuild(const std::unordered_map<TilePos, TilePos, TilePosHash>& came_from, const TilePos& from,
                             const TilePos& to) {
