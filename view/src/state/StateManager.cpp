...
void StateManager::pop() { pending_.push_back({Action::Pop, nullptr, 0}); }

void StateManager::pop_to_depth(const std::size_t depth) { pending_.push_back({Action::PopToDepth, nullptr, depth}); }

void StateManager::quit() { pending_.push_back({Action::Quit, nullptr, 0}); }
...
void StateManager::flush() { apply_pending(); }
