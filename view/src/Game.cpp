...
sif::asset::AssetHandle<sif::asset::Font> Game::ui_font() const { return assets_->font(assets::ui_font); }
...
std::string Game::scene_path(const std::string& scene_file) const { return data_dir_ + "bin/scenes/" + scene_file; }

void Game::click() const { audio_->play(assets_->sound(assets::sfx_menu), 0.8f); }
} // namespace bomberman::view
