...
bool EntityView::orphaned() const { return model_.expired(); }

void EntityView::update(const float dt) { elapsed_ += dt; }
...
void ViewRegistry::clear() { views_.clear(); }

std::size_t ViewRegistry::size() const { return views_.size(); }
