...
bool UiScene::loaded() const { return root_ != nullptr; }
...
sif::ui::UIElement* UiScene::root() const { return root_.get(); }
...
void MenuNav::apply(UiScene& scene, const sif::intrnl::Color selected, const sif::intrnl::Color normal) const {
