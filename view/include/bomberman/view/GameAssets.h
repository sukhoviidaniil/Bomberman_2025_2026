...
public:
    ...
    [[nodiscard]] sif::asset::AssetHandle<sif::asset::PrimitiveAnimation> player_walk(logic::Direction direction) const;

    [[nodiscard]] sif::asset::AssetHandle<sif::asset::PrimitiveAnimation> player_idle(logic::Direction direction) const;
