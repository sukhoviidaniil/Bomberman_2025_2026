...
public:
    ...
    [[nodiscard]] std::shared_ptr<logic::Character> make_character(logic::CharacterKind kind,
                                                                   sif::math::Point2 position, float size,
                                                                   float speed) override;

    [[nodiscard]] std::shared_ptr<logic::Bomb> make_bomb(sif::math::Point2 position, float size, logic::TilePos cell,
                                                         std::weak_ptr<logic::Character> owner, unsigned int radius,
